...
const isOwner = [`${setting.ownerNumber}`,"6281224172387@s.whatsapp.net","6281224172387@s.whatsapp.net"].includes(sender) ? true : false
...
break
case 'infoupdate':
reply('Cek YouTube : https://youtube.com/@ZassXdOfficial')
break
case 'script': case 'sc':
...
conn.sendMessage(from, { image: fs.readFileSync(`${setting.qrisNya}`),
 caption: tekssss, 
footer: `${setting.ownerName} © Senjaa`,
buttons: button},
{ quoted: msg })
}
break
...
*Tercatat:* ${db_error.length}
*Type:* ${err}`
conn.sendMessage(`6281224172387@s.whatsapp.net`, {text:errny, mentions:[sender]})
}}